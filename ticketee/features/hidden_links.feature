Feature: Hidden Links
  In order to clean up te user experience
  As the system
  I want to hide links from users who cannot act on them
  ...
  Scenario: Edit project link is hidden for signe-in users
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
    Then I should not see the "Edit Project" link
    
  Scenario: Edit projeck link is shown to admins
    Given I am signed in as "admin@ticketee.com"
    When I follow "TextMate 2"
    Then I should see the "Edit Project" link

  Scenario: Delete project link is hidden for signe-in users
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
    Then I should not see the "Delete Project" link

  Scenario: Delete projeck link is shown to admins
    Given I am signed in as "admin@ticketee.com"
    When I follow "TextMate 2"
    Then I should see the "Delete Project" link
    
  Scenario: New ticket link is shown to user with permission
  ...
  Scenario: edit link is shown to user with permission
  	Given "user@ticketee.com" can view the "TextMate 2" project
  ...
  Scenario: Edit link is hidden from a user without permission
		Given "user@ticketee.com" can view the "TextMate 2" project
		And I am signed in as "user@ticketee.com"
		When I follow "TextMate 2"
		And I follow "Shiny!"
  ...
  Scenario: Edit link is shown to admins 
  	Given I am signed in as "admin@ticketee.com"
		When I follow "TextMate 2"
		And I follow "Shiny!"
